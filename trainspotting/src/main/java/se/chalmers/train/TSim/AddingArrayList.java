...
/* package */ class AddingArrayList<E> {
	...
	/**
	 * Assigns elem at position index. if needed, size is expanded to be at least
	 * index+1.
	 */
	...
	/**
	 * Returns element at position index. If necessary, array is first expanded to
	 * size at least index+1.
	 */
